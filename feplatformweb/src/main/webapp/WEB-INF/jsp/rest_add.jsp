...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post" action="/rest_reg">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>短信日发送量：</td>
	            <td>
	                <input class="easyui-numberbox" type="text" name="rmaxday" data-options="validType:'length[1,30]'" />
	            </td>
	        </tr>
...
//		alert($("#itemAddForm").serialize());
		$.post("/rest_reg",$("#itemAddForm").serialize(), function(data){
