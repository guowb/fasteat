...
<div class="container">
            ...
            <form id="J_Form" class="form-horizontal span24 bui-form-horizontal bui-form bui-form-field-container" aria-disabled="false" method="post" action="/addFood.html" aria-pressed="false">
                <div class="row" style="margin-top: 2px">
                    <div class="control-group span8">
                        <label class="control-label"><s>*</s>菜品名称：</label>
                        <div class="controls">
                            <input name="fname" type="text" data-rules="{required:true}" class="input-normal control-text bui-form-field" aria-disabled="false" aria-pressed="false">
                        </div>
                    </div>
                    <div class="control-group span8">
                ...
                <div class="row">
                    <div class="control-group span15">
                        ...
                        <div class="controls">
                            <input name="fprice" type="number" data-rules="{required:true}" class="input-normal control-text bui-form-field" aria-disabled="false" aria-pressed="false">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="control-group span15">
                        ...
                        <div class="controls control-row4">
                            <textarea name="fdesc" class="input-large bui-form-field" data-tip="{text:'请填写菜品信息！'}" type="text" aria-disabled="false" aria-pressed="false"></textarea>
                ...
                <div class="row">
                    <div class="control-group span15">
                        ...
                        <div class="controls" style="width: 100px;height: 100px">
                            <img src="${map.photo}" alt="" width="100px" border="1px" height="100px">
                            <input name="fphoto" type="hidden" value="${map.photo}">
                        </div>
                    </div>
                </div>
            </form>
