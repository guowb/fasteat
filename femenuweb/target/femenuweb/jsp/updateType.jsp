...
<body>
<div class="span12">
    <form id="T_form" method="post" action="/updateType.html">
        <fieldset>
            <legend style="color: #0c147a"><b>添加菜种类</b></legend><input type="text" name="tname" id="tname" value="${type.tname}"/>
            <input type="hidden" name="rid" value="1"><input type="hidden" name="tid" value="${type.tid}">
            <span class="help-block">请勿重复菜品种类.</span>
        </fieldset>
        <p>
